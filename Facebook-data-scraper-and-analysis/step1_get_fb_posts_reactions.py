# This is based on https://github.com/Digitaalhumanitaaria/facebook-page-post-scraper
# coding: utf-8
...
app_id = "your app_id"
app_secret = "your app_secret" # DO NOT SHARE WITH ANYONE!
page_id = "228735667216"  #this example is of BBC news, find your own
        ...
        with open('%s_facebook_statuses.csv' % page_id, 'wb') as file:
            ...
            while has_next_page:
                for status in statuses['data']:
                    ...
                    if limited == True and num_processed >= limit:#W New line for limit
                        has_next_page = False#W New line for limit
...
if __name__ == '__main__':
    #for page_id in page_id_list:
    scrapeFacebookPageFeedStatus(page_id_list, access_token)
