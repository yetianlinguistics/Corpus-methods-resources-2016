...
#based on https://github.com/jeffreybreen/twitter-sentiment-analysis-tutorial-201107/tree/master/data/opinion-lexicon-English
...
writeLines(text = media$status_message, con = ".../bbc.txt")